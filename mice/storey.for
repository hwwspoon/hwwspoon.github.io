...
c          *********************************************************
c          *                                                       *
c          *  STOREY.FOR WAS ADAPTED FOR "MICE" FROM INTRAT.FOR    *
c          *             BY H.W.W. SPOON (MPE) 21-10-98            *
c          *                                                       *
c          *  Adaptations:                                         *
c          *  - output to file is supressed                        *
c          *  - paths have been added to input files               *
c          *                                                       *
c          *********************************************************
c
c
...
c     *********************************************************
c     *                                                       *
c     *  MICE USERS: adapt path below to local situation      *
c     *              i.e. replace user1$disk:[model.storey]   *
c     *              by your local path to the files "e*.d"   *
c     *                                                       *
c     *********************************************************
      open(unit=15,
     >     file='/data/hspoon/storey/e'//name//'.d',       
     >     status='old')
c
